...
public class SWTGLRenderer implements IGLRender {
	/** The width of the display */
	private int width;
	/** The height of the display */
	private int height;
	
	private float red=-1, green, blue, alpha;
	private int textureId = -1;
	private int blendSrc = -1, blendDst = -1;
	...
	public void initDisplay(int width, int height) {
		...
		System.err.println("initDisplay:"+extensions);
	}
