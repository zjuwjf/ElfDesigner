...
public class TheQuadExampleUpdateVBO {
	...
	private void setupShaders() {		
		...
		vsId = this.loadShader("src/com/ielfgame/stupidGame/test/vertex_textured.glsl", GL20.GL_VERTEX_SHADER);
		// Load the fragment shader
		fsId = this.loadShader("src/com/ielfgame/stupidGame/test/fragment_textured.glsl", GL20.GL_FRAGMENT_SHADER);
